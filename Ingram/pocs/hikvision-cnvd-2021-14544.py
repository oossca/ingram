...
class HikvisionCNVD202114544(POCTemplate):
    ...
    def verify(self, ip, port=80):
        ...
        try:
            ...
            if r.status_code == 200 and 'drivers' in r.text:
...
POCTemplate.register_poc(HikvisionCNVD202114544)
